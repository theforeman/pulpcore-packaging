...
Requires:       python%{python3_pkgversion}-opentelemetry_exporter_otlp_proto_grpc >= %{version}
Requires:       python%{python3_pkgversion}-opentelemetry_exporter_otlp_proto_http >= %{version}
