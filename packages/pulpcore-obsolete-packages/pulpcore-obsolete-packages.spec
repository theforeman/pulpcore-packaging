...
%changelog
* Tue Jul 22 2026 Zach Huntington-Meath <zhunting@redhat.com> - 1.5.0-2
- Fix off-by-one in Obsoletes release bounds (use last-shipped+1 to match .elN suffix)
- Drop python3.12-importlib-metadata, python3.12-importlib-resources, and
  python3.12-zipp Obsoletes (packages restored as still-needed dependencies)
