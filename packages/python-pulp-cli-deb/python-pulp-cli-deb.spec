...
Requires:       python%{python3_pkgversion}-pulp-cli < 0.41
Requires:       python%{python3_pkgversion}-pulp-glue-deb == 0.5.0
...
%changelog
* Tue Sep 15 17:54:54 UTC 2026 Foreman Packaging Automation <packaging@theforeman.org> - 0.5.0-1
- Update to 0.5.0
