...
Requires:       %{?scl_prefix}python%{python3_pkgversion}-pulp-ansible >= 1:0.13.5
...
%changelog
* Thu Feb 02 2023 Odilon Sousa <osousa@redhat.com> - 4.5.5-1
- Release python-galaxy-ng 4.5.5

* Tue Sep 27 2022 Odilon Sousa <osousa@redhat.com> - 4.5.3-1
- Release python-galaxy-ng 4.5.3
