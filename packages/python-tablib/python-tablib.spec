...
BuildRequires:  python%{python3_pkgversion}-setuptools-scm >= 6.2
...
%changelog
* Sun Aug 09 2026 Foreman Packaging Automation <packaging@theforeman.org> - 3.10.0-1
- Update to 3.10.0
...
* Wed Sep 18 2024 Foreman Packaging Automation <packaging@theforeman.org> - 3.5.0-1
- Update to 3.5.0
