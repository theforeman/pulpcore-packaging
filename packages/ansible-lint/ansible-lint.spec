...
# ansible-core is provided by foreman-packaging, not listed as Requires here
Requires:       python%{python3_pkgversion}-ansible-compat >= 4.1.11
Requires:       python%{python3_pkgversion}-black >= 22.8.0
...
- Update Requires for 6.22.2: add ansible-compat, black, filelock, jsonschema, pathspec, subprocess-tee, yamllint; remove enrich, tenacity, typing-extensions
- Drop setuptools_scm_git_archive BuildRequires (not needed in 6.22.2)
