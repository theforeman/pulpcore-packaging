...
Requires:       python%{python3_pkgversion}-oauthlib >= 3.0.0
...
%license LICENSE
%doc README.rst
%{python3_sitelib}/requests_oauthlib
%{python3_sitelib}/requests_oauthlib-%{version}-py%{python3_version}.egg-info


%changelog
* Tue Jan 16 2024 Odilon Sousa <osousa@redhat.com> - 1.3.0-6
- Remove SCL bits
...
* Sat Nov 11 2023 Odilon Sousa <osousa@redhat.com> - 1.3.0-3
