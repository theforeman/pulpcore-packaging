...
- Restore package: python3.12-importlib-metadata (restored in this same PR)
  ...
  incorrectly removed in the EL10 obsolete-package cleanup (#2766), breaking
  repoclosure

* Wed Jun 10 2026 Foreman Packaging Automation <packaging@theforeman.org> - 4.1.0-1
- Update to 4.1.0

* Wed Apr 15 2026 Foreman Packaging Automation <packaging@theforeman.org> - 3.23.1-1
- Update to 3.23.1
